...
{
    public:
        static XItem* CreateAnyItem(ItemKind kind = IM_ITEM, ITEM_TYPE it = IT_RANDOM, int low_v = 0, int hi_v = 10000);

        static XItem* CreateItem(ItemKind kind = IM_ITEM, ITEM_TYPE it = IT_RANDOM);
};
