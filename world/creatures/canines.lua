...
Monster.new("dog")
	...
	:Basic("1d10+100", "0d0+1000", "1d100+900", CreatureSize.SMALL, "1d100+200")
	:Body("", 0, 0)
...
Monster.new("large_dog")
	...
	:Basic("1d10+100", "0d0+1000", "1d100+900", CreatureSize.SMALL, "1d200+300")
	:Body("", 0, 0)
	:AI(XStandardAI.HI_ANIMAL + XStandardAI.ALLOW_PACK + XStandardAI.ALLOW_PACK)
...
Monster.new("rabid_dog")
	...
	:Basic("1d10+120", "0d0+1000", "1d100+700", CreatureSize.SMALL, "1d100+200")
	:Body("", 0, 0)
	...
	:CorpseEffect(CorpseEffectType.DISEASE, 50)
	:Register()

Monster.new("wolf")
	:View("wolf", 'C', xColor.xLIGHTGRAY, PersonType.IT, CreatureTemplate.LOW, CreatureClass.CANINE)
	:Basic("1d10+130", "0d0+1000", "1d100+700", CreatureSize.SMALL, "1d300+500")
	:Body("", 0, 0)
	:AI(XStandardAI.HI_ANIMAL + XStandardAI.ALLOW_PACK)
...
Monster.new("large_wolf")
	...
	:Basic("1d10+130", "0d0+1000", "1d100+700", CreatureSize.NORMAL, "1d300+700")
	:Body("", 0, 0)
	:AI(XStandardAI.HI_ANIMAL + XStandardAI.ALLOW_PACK)
...
Monster.new("werewolf")
	...
	:Basic("1d10+150", "0d0+1000", "1d100+500", CreatureSize.NORMAL, "1d300+1000")
	:Body("", 0, 0)
	...
	:CorpseEffect(CorpseEffectType.MODIFY_R_PARALYSE, 5)
	:CorpseEffect(CorpseEffectType.DISEASE, 50)
	:Register()
