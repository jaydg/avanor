...
Monster.new("tarantula")
	...
	:CorpseModifier(Modifier.POISON, 15)
	:Register()
...
Monster.new("scorpion")
	...
	:CorpseModifier(Modifier.POISON, 20)
	:CorpseModifier(Modifier.PARALYSE, 20)
	:Register()
...
Monster.new("black_scorpion")
	...
	:CorpseModifier(Modifier.POISON, 30)
	:CorpseModifier(Modifier.PARALYSE, 30)
	:Register()
...
Monster.new("pink_scorpion")
	...
	:CorpseModifier(Modifier.POISON, 50)
	:CorpseModifier(Modifier.PARALYSE, 50)
	:Register()
...
Monster.new("killer_beetle")
	...
	:CorpseEffect(CorpseEffectType.STOMACH, 5)
	:Register()
...
Monster.new("death_beetle")
	...
	:CorpseEffect(CorpseEffectType.STOMACH, 10)
	:Register()
