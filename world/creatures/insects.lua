...
Monster.new("spider")
	:View("spider", 'S', xColor.xBROWN, PersonType.IT, CreatureTemplate.VERY_LOW, "insect")
...
Monster.new("giant_spider")
	:View("giant spider", 'S', xColor.xLIGHTGRAY, PersonType.IT, CreatureTemplate.VERY_LOW, "insect")
...
Monster.new("tarantula")
	:View("tarantula", 'S', xColor.xLIGHTGRAY, PersonType.IT, CreatureTemplate.LOW, "insect")
...
Monster.new("scorpion")
	:View("scorpion", 'S', xColor.xYELLOW, PersonType.IT, CreatureTemplate.LOW, "insect")
	:Basic("1d10+70", "0d0+1000", "1d100+600", CreatureSize.VERY_SMALL, "3d4")
	:Body("", 0, 0)
	:AI(XStandardAI.INSECT)
	:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
...
Monster.new("black_scorpion")
	:View("black scorpion", 'S', xColor.xDARKGRAY, PersonType.IT, CreatureTemplate.LOW, "insect")
	:Basic("1d10+70", "0d0+1000", "1d100+600", CreatureSize.VERY_SMALL, "3d4")
	:Body("", 0, 0)
	:AI(XStandardAI.INSECT)
	:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
...
Monster.new("pink_scorpion")
	:View("pink scorpion", 'S', xColor.xLIGHTMAGENTA, PersonType.IT, CreatureTemplate.AVG, "insect")
	:Basic("1d10+70", "0d0+1000", "1d100+600", CreatureSize.VERY_SMALL, "3d4")
	:Body("", 0, 0)
	:AI(XStandardAI.INSECT)
	:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
...
Monster.new("centipede")
	:View("centipede", 'S', xColor.xLIGHTGRAY, PersonType.IT, CreatureTemplate.VERY_LOW, "insect")
...
Monster.new("stegocentipede")
	:View("stegocentipede", 'S', xColor.xDARKGRAY, PersonType.IT, CreatureTemplate.LOW, "insect")
	:Basic("1d30+80", "0d0+1000", "1d100+950", CreatureSize.VERY_SMALL, "3d4")
	:Body("", 0, 0)
	:AI(XStandardAI.INSECT)
	:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
...
Monster.new("dungeon_crawler")
	:View("dungeon crawler", 'c', xColor.xWHITE, PersonType.IT, CreatureTemplate.VERY_LOW, "insect")
...
Monster.new("giant_crawler")
	:View("giant crawler", 'c', xColor.xLIGHTGRAY, PersonType.IT, CreatureTemplate.AVG, "insect")
...
Monster.new("carrion_crawler")
	:View("carrion crawler", 'c', xColor.xDARKGRAY, PersonType.IT, CreatureTemplate.AVG, "insect")
