...
Monster.new("kobold")
	...
	:Equip(ItemKind.MISSILEW, "short_bow", 10)
...
Monster.new("large_kobold")
	...
	:Equip(ItemKind.WEAPON, "dagger", 100)
	:Equip(ItemKind.WEAPON, "dagger", 10)
	:Equip(ItemKind.MISSILEW, "short_bow", 15)
...
Monster.new("chieftain_kobold")
	...
	:Equip(ItemKind.WEAPON, "dagger", 100)
	:Equip(ItemKind.WEAPON, "dagger", 20)
	:Equip(ItemKind.MISSILEW, "short_bow", 10)
	:CorpseEffect(CorpseEffectType.DISEASE, 30)
	:Register()
...
Monster.new("gnoll")
	...
	:LearnSkill(XSkill.FINDWEAKNESS, 6)
	:EquipCount(ItemKind.SCROLL + ItemKind.POTION + ItemKind.BOOK + ItemKind.FOOD, 2, 10)
	:Equip(ItemKind.WEAPON, "war_axe", 100)
