...
Monster.new("orc")
	:View("orc", 'o', xColor.xLIGHTGREEN, PersonType.HE, CreatureTemplate.AVG, "orc")
...
Monster.new("large_orc")
	:View("large orc", 'o', xColor.xGREEN, PersonType.HE, CreatureTemplate.AVG, "orc")
	:Basic("1d10+95", "0d0+1000", "0d0+1000", CreatureSize.NORMAL, "1d400+1400")
	:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
	:AI(XStandardAI.CREATURE)
...
Monster.new("hill_orc")
	:View("hill orc", 'o', xColor.xYELLOW, PersonType.HE, CreatureTemplate.AVG, "orc")
	:Basic("1d10+95", "0d0+1000", "0d0+1000", CreatureSize.NORMAL, "1d400+1400")
	:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
	:AI(XStandardAI.CREATURE)
...
Monster.new("dark_orc")
	:View("dark orc", 'o', xColor.xDARKGRAY, PersonType.HE, CreatureTemplate.AVG, "orc")
	:Basic("1d10+95", "0d0+1000", "0d0+1000", CreatureSize.NORMAL, "1d400+1400")
	:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
	:AI(XStandardAI.CREATURE)
...
Monster.new("lieutenant_orc")
	:View("orc lieutenant", 'o', xColor.xBROWN, PersonType.HE, CreatureTemplate.AVG, "orc")
	:Basic("1d10+95", "0d0+1000", "0d0+1000", CreatureSize.NORMAL, "1d400+1400")
	:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
	:AI(XStandardAI.CREATURE)
	:Stats("St 2d5+30 Dx 1d5+5 To 2d5+30 Le 1d4 Wi 1d4 Ma 1d4 Pe 3d3 Ch 1d5")
...
Monster.new("captain_orc")
	:View("orc captain", 'o', xColor.xBROWN, PersonType.HE, CreatureTemplate.AVG, "orc")
	:Basic("1d10+95", "0d0+1000", "0d0+1000", CreatureSize.NORMAL, "1d400+1400")
	:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
	:AI(XStandardAI.CREATURE)
...
Monster.new("chieftain_orc")
	:View("orc chieftain", 'o', xColor.xBLUE, PersonType.HE, CreatureTemplate.AVG, "orc")
	:Basic("1d10+95", "0d0+1000", "0d0+1000", CreatureSize.NORMAL, "1d400+1400")
	:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
	:AI(XStandardAI.CREATURE)
