...
------------------------------ HUMANS & HUMANOIDS --------------------------------------	
	...
	Monster.new("farmer")
		...
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 0, CREATURE_DEF.SUPPRESS_INVIS)
	...
	Monster.new("royal_guard")
		...
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, CREATURE_DEF.SUPPRESS_INVIS + CREATURE_DEF.SEE_INVIS)
		:AI(XStandardAI.HUMAN + XStandardAI.PEACEFUL)
	...
	Monster.new("shopkeeper")
		...
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 100, CREATURE_DEF.SUPPRESS_INVIS + CREATURE_DEF.SEE_INVIS)
	...
	Monster.new("dwarf_guard")
		...
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, CREATURE_DEF.SEE_INVIS)
		:AI(XStandardAI.RANDOM_MOVE + XStandardAI.ALLOW_PICK_UP + XStandardAI.ALLOW_WEAR_ITEM + XStandardAI.COWARD + XStandardAI.PEACEFUL)
...
------------------------------ UNIQUE --------------------------------------	
	...
	Monster.new("beelzevile")
		...
		:Body("head body ring ring", 100, CREATURE_DEF.SUPPRESS_INVIS + CREATURE_DEF.SEE_INVIS)
		:AI(XStandardAI.RANDOM_MOVE + XStandardAI.ALLOW_PICK_UP + XStandardAI.ALLOW_WEAR_ITEM + XStandardAI.COWARD)
