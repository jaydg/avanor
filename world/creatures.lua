...
------------------------------ KOBOLDS --------------------------------------
	...
	Monster.new("kobold")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_DAGGER, 100)
		:Equip(ItemKind.MISSILEW, ITEM_TYPE.IT_SHORTBOW, 10)
	...
	Monster.new("large_kobold")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_DAGGER, 100)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_DAGGER, 10)
		:Equip(ItemKind.MISSILEW, ITEM_TYPE.IT_SHORTBOW, 15)
	...
	Monster.new("chieftain_kobold")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_DAGGER, 100)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_DAGGER, 20)
		:Equip(ItemKind.MISSILEW, ITEM_TYPE.IT_SHORTBOW, 10)
		:CorpseEffect(CET_DISEASE, 30)
		:Register()
	...
	Monster.new("gnoll")
		...
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(ItemKind.SCROLL + ItemKind.POTION + ItemKind.BOOK + ItemKind.FOOD, 2, 10)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_WARAXE, 100)
...
------------------------------ GOBLINS --------------------------------------	
	...
	Monster.new("goblin")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_SHORTSWORD, 100)
		:Register()
...
------------------------------ ORCS --------------------------------------	
	...
	Monster.new("orc")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_BATTLEAXE, 100)
		:Register()
...
------------------------------ HUMANS & HUMANOIDS --------------------------------------	
	...
	Monster.new("farmer")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_PITCHFORK, 100)
		:Equip(ItemKind.BODY, ITEM_TYPE.IT_ROBE, 100)
		:Register()
	...
	Monster.new("goodwife")
		...
		:LearnSkill(SKT_HEALING, 2)
		:Equip(ItemKind.BODY, ITEM_TYPE.IT_DRESS, 100)
		:Register()
	...
	Monster.new("bandit")
		...
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_LONGDAGGER, 100)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_LONGDAGGER, 100)
		:Unique()
		:Register()
	...
	Monster.new("citizen")
		...
		:Equip(ItemKind.BODY, ITEM_TYPE.IT_CLOTHES, 100)
		:Register()
	...
	Monster.new("royal_guard")
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_LONGSWORD, 100)
		:Equip(ItemKind.SHIELD, ITEM_TYPE.IT_TOWERSHIELD, 100)
		:Register()
	...
	Monster.new("dwarf_guard")
		...
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_BATTLEAXE, 100)
		:Equip(ItemKind.SHIELD, ITEM_TYPE.IT_LARGESHIELD, 100)
		:Register()
...
------------------------------ UNIQUE --------------------------------------	
	...
	Monster.new("elder_gridor")
		...
		:EquipCount(ItemKind.SCROLL + ItemKind.POTION, 3, 30)
		:Equip(ItemKind.BODY, ITEM_TYPE.IT_CLOTHES, 100)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_STAFF, 100)
		:Unique()
		:Register()
	...
	Monster.new("yohjishiro")
		...
		:LearnSpell(SPELL_HEAL)
		:Equip(ItemKind.HAT, ITEM_TYPE.IT_HAT, 100)
		:Equip(ItemKind.WEAPON, ITEM_TYPE.IT_STAFF, 100)
		:Unique()
		:Register()
