...
------------------------------ RATS --------------------------------------
	Monster.new("rat")
		:View("rat", 'r', xBROWN, CPT_IT, CRL_VERY_LOW, CR_RAT)
		:Basic("1d30+90", "0d0+1000", "1d200+600", CS_VERY_SMALL, "5d4")
		:Body("", 0, 0)
		:AI(AIF_COWARD + AIF_RANDOM_MOVE + AIF_ALLOW_PACK)
	...
	Monster.new("large_rat", "rat")
		:View("large rat", 'r', xBROWN, CPT_IT, CRL_VERY_LOW, CR_RAT)
	...
	Monster.new("black_rat", "rat")
		:View("black rat", 'r', xDARKGRAY, CPT_IT, CRL_LOW, CR_RAT)
	...
	Monster.new("huge_rat", "rat")
		:View("huge rat", 'r', xLIGHTGRAY, CPT_IT, CRL_LOW, CR_RAT)
...
------------------------------ BATS --------------------------------------	
	Monster.new("bat")
		:View("bat", 'b', xBROWN, CPT_IT, CRL_VERY_LOW, CR_RAT)
		:Basic("1d30+120", "0d0+1000", "1d200+800", CS_VERY_SMALL, "3d4")
		:Body("", 0, 0)
		:AI(AIF_COWARD + AIF_RANDOM_MOVE)
	...
	Monster.new("huge_bat", "bat")
		:View("huge bat", 'b', xLIGHTGRAY, CPT_IT, CRL_VERY_LOW, CR_RAT)
...
------------------------------ REPTILE --------------------------------------	
	...
	Monster.new("small_snake")
		:View("small snake", 'R', xLIGHTGRAY, CPT_IT, CRL_VERY_LOW, CR_REPTILE)
	...
	Monster.new("gray_snake", "small_snake")
		:View("gray snake", 'R', xLIGHTGRAY, CPT_IT, CRL_VERY_LOW, CR_REPTILE)
	...
	Monster.new("brown_snake", "gray_snake")
		:View("brown snake", 'R', xBROWN, CPT_IT, CRL_VERY_LOW, CR_REPTILE)
		:Resist("cold:1d10-30")
		:Combat("2d5", "1d4")
	...
	Monster.new("salamander", "gray_snake")
		:View("salamander", 'R', xRED, CPT_IT, CRL_LOW, CR_REPTILE)
	...
	Monster.new("large_snake", "gray_snake")
		:View("large snake", 'R', xLIGHTGRAY, CPT_IT, CRL_LOW, CR_REPTILE)
	...
	Monster.new("cobra", "gray_snake")
		:View("cobra", 'R', xGREEN, CPT_IT, CRL_LOW, CR_REPTILE)
	...
	Monster.new("king_cobra", "gray_snake")
		:View("king cobra", 'R', xLIGHTRED, CPT_IT, CRL_AVG, CR_REPTILE)
	...
	Monster.new("rattlesnake", "gray_snake")
		:View("rattlesnake", 'R', xRED, CPT_IT, CRL_AVG, CR_REPTILE)
...
------------------------------ FELINE --------------------------------------
	...
	Monster.new("cat")
		:View("cat", 'f', xBROWN, CPT_IT, CRL_VERY_LOW, CR_FELINE)
	...
	Monster.new("wild_cat")
		:View("wildcat", 'f', xLIGHTGRAY, CPT_IT, CRL_VERY_LOW, CR_FELINE)
...
------------------------------ CANINE --------------------------------------
	...
	Monster.new("dog")
		:View("dog", 'C', xBROWN, CPT_IT, CRL_VERY_LOW, CR_CANINE)
		:Basic("1d10+100", "0d0+1000", "1d100+900", CS_SMALL, "1d100+200")
		:Body("", 0, 0)
		:AI(AIF_HI_ANIMAL + AIF_ALLOW_PACK + AIF_ALLOW_PACK)
	...
	Monster.new("large_dog")
		:View("large dog", 'C', xBROWN, CPT_IT, CRL_VERY_LOW, CR_CANINE)
	...
	Monster.new("rabid_dog")
		:View("rabid dog", 'C', xBROWN, CPT_IT, CRL_LOW, CR_CANINE)
		:Basic("1d10+120", "0d0+1000", "1d100+700", CS_SMALL, "1d100+200")
		:Body("", 0, 0)
		:AI(AIF_HI_ANIMAL + AIF_ALLOW_PACK)
	...
	Monster.new("wolf")
		:View("wolf", 'C', xLIGHTGRAY, CPT_IT, CRL_LOW, CR_CANINE)
	...
	Monster.new("large_wolf")
		:View("large wolf", 'C', xLIGHTGRAY, CPT_IT, CRL_AVG, CR_CANINE)
	...
	Monster.new("werewolf")
		:View("werewolf", 'C', xDARKGRAY, CPT_IT, CRL_HI, CR_CANINE)
		...
		:Melee(BR_DISEASE, 100)
		:Melee(BR_PARALYSE, 20)
...
------------------------------ OOZE, JELLY, etc. --------------------------------------
	...
	Monster.new("gray_ooze")
		:View("gray ooze", 'j', xLIGHTGRAY, CPT_IT, CRL_LOW, CR_BLOB)
	...
	Monster.new("gelatinous_cube")
		:View("gelatinous cube", 'j', xWHITE, CPT_IT, CRL_AVG, CR_BLOB)
...
------------------------------ INSECTS --------------------------------------
	...
	Monster.new("spider")
		:View("spider", 'S', xBROWN, CPT_IT, CRL_VERY_LOW, CR_INSECT)
	...
	Monster.new("giant_spider")
		:View("giant spider", 'S', xLIGHTGRAY, CPT_IT, CRL_VERY_LOW, CR_INSECT)
	...
	Monster.new("tarantula")
		:View("tarantula", 'S', xLIGHTGRAY, CPT_IT, CRL_LOW, CR_INSECT)
		...
		:Melee(BR_POISON, 40)
		:Melee(BR_PARALYSE, 10)
		:CorpseEffect(CET_MODIFY_R_POISON, 2)
		:CorpseEffect(CET_POISON, 15)
		:Register()

	Monster.new("scorpion")
		:View("scorpion", 'S', xYELLOW, CPT_IT, CRL_LOW, CR_INSECT)
		:Basic("1d10+70", "0d0+1000", "1d100+600", CS_VERY_SMALL, "3d4")
		:Body("", 0, 0)
		:AI(AIF_INSECT)
		:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
	...
	Monster.new("black_scorpion")
		:View("black scorpion", 'S', xDARKGRAY, CPT_IT, CRL_LOW, CR_INSECT)
		:Basic("1d10+70", "0d0+1000", "1d100+600", CS_VERY_SMALL, "3d4")
		:Body("", 0, 0)
		:AI(AIF_INSECT)
		:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
	...
	Monster.new("pink_scorpion")
		:View("pink scorpion", 'S', xLIGHTMAGENTA, CPT_IT, CRL_AVG, CR_INSECT)
		:Basic("1d10+70", "0d0+1000", "1d100+600", CS_VERY_SMALL, "3d4")
		:Body("", 0, 0)
		:AI(AIF_INSECT)
		:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
	...
	Monster.new("fire_beetle")
		:View("fire beetle", 'i', xRED, CPT_IT, CRL_VERY_LOW, CR_INSECT)
	...
	Monster.new("frost_beetle")
		:View("frost beetle", 'i', xWHITE, CPT_IT, CRL_LOW, CR_INSECT)
	...
	Monster.new("green_beetle")
		:View("green beetle", 'i', xGREEN, CPT_IT, CRL_LOW, CR_INSECT)
	...
	Monster.new("killer_beetle")
		:View("killer beetle", 'i', xBLUE, CPT_IT, CRL_AVG, CR_INSECT)
	...
	Monster.new("death_beetle")
		:View("death beetle", 'i', xDARKGRAY, CPT_IT, CRL_HI, CR_INSECT)
	...
	Monster.new("giant_bee")
		:View("giant bee", 'b', xYELLOW, CPT_IT, CRL_AVG, CR_INSECT)
	...
	Monster.new("giant_wasp")
		:View("giant wasp", 'b', xBROWN, CPT_IT, CRL_AVG, CR_INSECT)
	...
	Monster.new("centipede")
		:View("centipede", 'S', xLIGHTGRAY, CPT_IT, CRL_VERY_LOW, CR_INSECT)
	...
	Monster.new("stegocentipede")
		:View("stegocentipede", 'S', xDARKGRAY, CPT_IT, CRL_LOW, CR_INSECT)
		:Basic("1d30+80", "0d0+1000", "1d100+950", CS_VERY_SMALL, "3d4")
		:Body("", 0, 0)
		:AI(AIF_INSECT)
		:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
	...
	Monster.new("dungeon_crawler")
		:View("dungeon crawler", 'c', xWHITE, CPT_IT, CRL_VERY_LOW, CR_INSECT)
	...
	Monster.new("giant_crawler")
		:View("giant crawler", 'c', xLIGHTGRAY, CPT_IT, CRL_AVG, CR_INSECT)
	...
	Monster.new("carrion_crawler")
		:View("carrion crawler", 'c', xDARKGRAY, CPT_IT, CRL_AVG, CR_INSECT)
		:Basic("1d10+50", "0d0+1000", "1d100+200", CS_LARGE, "20d4")
		:Body("", 0, 0)
		:AI(AIF_INSECT)
		:Stats("St 1d1 Dx 1d1 To 1d1 Le 1d1 Wi 1d1 Ma 1d1 Pe 1d1 Ch 1d1")
...
------------------------------ KOBOLDS --------------------------------------
	...
	Monster.new("kobold")
		:View("kobold", 'k', xLIGHTGREEN, CPT_HE, CRL_VERY_LOW, CR_KOBOLD)
		...
		:AI(AIF_CREATURE + AIF_ALLOW_PACK)
		...
		:EquipCount(IM_SCROLL + IM_POTION + IM_BOOK + IM_FOOD, 2, 10)
		:Equip(IM_WEAPON, IT_DAGGER, 100)
		:Equip(IM_MISSILEW, IT_SHORTBOW, 10)
		:CorpseEffect(CET_DISEASE, 20)
		:Register()

	Monster.new("large_kobold")
		:View("large kobold", 'k', xGREEN, CPT_HE, CRL_LOW, CR_KOBOLD)
		...
		:EquipCount(IM_SCROLL + IM_POTION + IM_BOOK + IM_FOOD, 3, 12)
		:Equip(IM_WEAPON, IT_DAGGER, 100)
		:Equip(IM_WEAPON, IT_DAGGER, 10)
		:Equip(IM_MISSILEW, IT_SHORTBOW, 15)
		:CorpseEffect(CET_DISEASE, 30)
		:Register()

	Monster.new("chieftain_kobold")
		:View("kobold chieftain", 'k', xGREEN, CPT_HE, CRL_LOW, CR_KOBOLD)
		:Basic("1d10+90", "0d0+1000", "0d0+1000", CS_SMALL, "1d200+800")
		...
		:EquipCount(IM_SCROLL + IM_POTION + IM_BOOK + IM_FOOD, 4, 15)
		:Equip(IM_WEAPON, IT_DAGGER, 100)
		:Equip(IM_WEAPON, IT_DAGGER, 20)
		:Equip(IM_MISSILEW, IT_SHORTBOW, 10)
		:CorpseEffect(CET_DISEASE, 30)
		:Register()
	...
	Monster.new("shaman_kobold")
		:View("kobold shaman", 'k', xLIGHTCYAN, CPT_HE, CRL_LOW, CR_KOBOLD)
		:Basic("1d10+90", "0d0+1000", "0d0+1000", CS_SMALL, "1d200+600")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 5, 0)
		:AI(AIF_CREATURE + AIF_ALLOW_PACK)
	...
	Monster.new("gnoll")
		:View("gnoll", 'g', xBROWN, CPT_HE, CRL_ABOVE_LOW, CR_KOBOLD)
		...
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(IM_SCROLL + IM_POTION + IM_BOOK + IM_FOOD, 2, 10)
		:Equip(IM_WEAPON, IT_WARAXE, 100)
		:CorpseEffect(CET_MODIFY_TO, 1)
		:Register()

	Monster.new("gnoll_warmaster")
		:View("gnoll warmaster", 'g', xYELLOW, CPT_HE, CRL_AVG, CR_KOBOLD)
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(IM_SCROLL + IM_POTION + IM_BOOK + IM_FOOD, 3, 10)
		:Equip(IM_WEAPON, IT_WARAXE, 100)
		:CorpseEffect(CET_MODIFY_TO, 1)
		:Register()
...
------------------------------ GOBLINS --------------------------------------	
	...
	Monster.new("goblin")
		:View("goblin", 'g', xLIGHTGREEN, CPT_HE, CRL_VERY_LOW, CR_GOBLIN)
		:Basic("1d10+90", "0d0+1000", "0d0+1000", CS_SMALL, "1d200+800")
		...
		:LearnSkill(SKT_HEALING, 4)
		:LearnSkill(SKT_FINDWEAKNESS, 4)
		:EquipCount(IM_SCROLL + IM_POTION, 1, 10)
		:Equip(IM_WEAPON, IT_SHORTSWORD, 100)
		:Register()

	Monster.new("goblin_warrior")
		:View("goblin warrior", 'g', xGREEN, CPT_HE, CRL_LOW, CR_GOBLIN)
		...
		:LearnSkill(SKT_HEALING, 5)
		:LearnSkill(SKT_FINDWEAKNESS, 5)
		:EquipCount(IM_SCROLL + IM_POTION, 2, 10)
		:Equip(IM_WEAPON, IT_SHORTSWORD, 100)
		:Register()

	Monster.new("goblin_warmaster")
		:View("goblin warmaster", 'g', xBLUE, CPT_HE, CRL_LOW, CR_GOBLIN)
		:Basic("1d10+100", "0d0+1000", "0d0+1000", CS_SMALL, "1d200+800")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 7, 0)
		:AI(AIF_CREATURE)
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(IM_SCROLL + IM_POTION, 3, 10)
		:Equip(IM_WEAPON, IT_SHORTSWORD, 100)
		:Register()

	Monster.new("goblin_chieftain")
		:View("goblin chieftain", 'g', xRED, CPT_HE, CRL_AVG, CR_GOBLIN)
		:Basic("1d10+100", "0d0+1000", "0d0+1000", CS_SMALL, "1d200+800")
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(IM_SCROLL + IM_POTION, 4, 10)
		:Equip(IM_WEAPON, IT_SHORTSWORD, 100)
		:Register()
...
------------------------------ ORCS --------------------------------------	
	...
	Monster.new("orc")
		:View("orc", 'o', xLIGHTGREEN, CPT_HE, CRL_AVG, CR_ORC)
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(IM_SCROLL + IM_POTION, 3, 50)
		:Equip(IM_WEAPON, IT_BATTLEAXE, 100)
		:Register()

	Monster.new("large_orc")
		:View("large orc", 'o', xGREEN, CPT_HE, CRL_AVG, CR_ORC)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d400+1400")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
		:AI(AIF_CREATURE)
	...
	Monster.new("hill_orc")
		:View("hill orc", 'o', xYELLOW, CPT_HE, CRL_AVG, CR_ORC)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d400+1400")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
		:AI(AIF_CREATURE)
	...
	Monster.new("dark_orc")
		:View("dark orc", 'o', xDARKGRAY, CPT_HE, CRL_AVG, CR_ORC)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d400+1400")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
		:AI(AIF_CREATURE)
	...
	Monster.new("lieutenant_orc")
		:View("orc lieutenant", 'o', xBROWN, CPT_HE, CRL_AVG, CR_ORC)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d400+1400")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
		:AI(AIF_CREATURE)
		:Stats("St 2d5+30 Dx 1d5+5 To 2d5+30 Le 1d4 Wi 1d4 Ma 1d4 Pe 3d3 Ch 1d5")
	...
	Monster.new("captain_orc")
		:View("orc captain", 'o', xBROWN, CPT_HE, CRL_AVG, CR_ORC)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d400+1400")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
		:AI(AIF_CREATURE)
	...
	Monster.new("chieftain_orc")
		:View("orc chieftain", 'o', xBLUE, CPT_HE, CRL_AVG, CR_ORC)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d400+1400")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 30, 0)
		:AI(AIF_CREATURE)
...
------------------------------ HUMANS & HUMANOIDS --------------------------------------	
	...
	Monster.new("farmer")
		:View("farmer", 'p', xBROWN, CPT_HE, CRL_VERY_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 0, GFS_SUPRESS_INVIS)
		:AI(AIF_HUMAN + AIF_PEACEFUL)
		...
		:Equip(IM_WEAPON, IT_PITCHFORK, 100)
		:Equip(IM_BODY, IT_ROBE, 100)
		:Register()

	Monster.new("goodwife")
		:View("goodwife", 'p', xYELLOW, CPT_SHE, CRL_VERY_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 0, GFS_SUPRESS_INVIS)
		:AI(AIF_HUMAN + AIF_PEACEFUL)
		:Stats("St 2d3 Dx 2d3 To 1d3 Le 2d3 Wi 1d3 Ma 1d2 Pe 1d6+6 Ch 1d3")
		...
		:LearnSkill(SKT_HEALING, 2)
		:Equip(IM_BODY, IT_DRESS, 100)
		:Register()


	Monster.new("bandit")
		:View("bandit", 'p', xLIGHTGRAY, CPT_HE, CRL_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:EquipCount(IM_SCROLL + IM_POTION, 3, 30)
		:Equip(IM_WEAPON, IT_LONGDAGGER, 100)
		:Equip(IM_WEAPON, IT_LONGDAGGER, 100)
		:Unique()
		:Register()

	Monster.new("citizen")
		:View("citizen", 'p', xLIGHTGRAY, CPT_HE, CRL_VERY_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 0, GFS_SUPRESS_INVIS)
		:AI(AIF_HUMAN + AIF_PEACEFUL)
		:Stats("St 2d3 Dx 2d3 To 1d3 Le 2d3 Wi 1d3 Ma 1d2 Pe 1d6+6 Ch 1d3")
		...
		:Equip(IM_BODY, IT_CLOTHES, 100)
		:Register()

	Monster.new("fcitizen")
		:View("citizen", 'p', xLIGHTGRAY, CPT_SHE, CRL_VERY_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 0, GFS_SUPRESS_INVIS)
		:AI(AIF_HUMAN + AIF_PEACEFUL)
		:Stats("St 2d3 Dx 2d3 To 1d3 Le 2d3 Wi 1d3 Ma 1d2 Pe 1d6+6 Ch 1d3")
	...
	Monster.new("royal_guard")
		:View("royal guardian", 'p', xBLUE, CPT_HE, CRL_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_HUMAN + AIF_PEACEFUL)
		...
		:LearnSkill(SKT_HEALING, 6)
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:Equip(IM_WEAPON, IT_LONGSWORD, 100)
		:Equip(IM_SHIELD, IT_TOWERSHIELD, 100)
		:Register()

	Monster.new("death_knight")
		:View("death knight", 'p', xDARKGRAY, CPT_HE, CRL_LOW, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD)
	...
	Monster.new("shopkeeper")
		:View("shopkeeper", 'p', xLIGHTGRAY, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
		:Basic("1d10+120", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 100, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
	...
	Monster.new("dwarf")
		:View("dwarf", 'h', xBROWN, CPT_HE, CRL_VERY_LOW, CR_HUMANOID)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
	...
	Monster.new("dwarf_guard")
		:View("dwarven guardian", 'h', xLIGHTBLUE, CPT_HE, CRL_VERY_LOW, CR_HUMANOID)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
		...
		:LearnSkill(SKT_FINDWEAKNESS, 6)
		:Equip(IM_WEAPON, IT_BATTLEAXE, 100)
		:Equip(IM_SHIELD, IT_LARGESHIELD, 100)
		:Register()
...
------------------------------ UNDEAD --------------------------------------	
	...
	Monster.new("skeleton")
		:View("skeleton", 's', xWHITE, CPT_IT, CRL_VERY_LOW, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body hand hand", 2, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM)
	...
	Monster.new("zombie")
		:View("zombie", 'z', xBROWN, CPT_IT, CRL_LOW, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
	...
	Monster.new("ghoul")
		:View("ghoul", 'z', xLIGHTGRAY, CPT_IT, CRL_LOW, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
	...
	Monster.new("ghost")
		:View("ghost", 'G', xLIGHTGRAY, CPT_IT, CRL_ABOVE_LOW, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("", 0, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM)
	...
	Monster.new("spectre")
		:View("spectre", 'G', xMAGENTA, CPT_IT, CRL_AVG, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("", 0, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM)
		:Stats("St 6d5 Dx 4d5 To 2d5 Le 5d5 Wi 5d5 Ma 5d5 Pe 1d2 Ch 1d1")
	...
	Monster.new("dread")
		:View("dread", 'G', xBROWN, CPT_IT, CRL_HI, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("", 0, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM)
	...
	Monster.new("vampire")
		:View("vampire", 'V', xBLUE, CPT_HE, CRL_HI, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
	...
	Monster.new("lich")
		:View("lich", 'L', xLIGHTGRAY, CPT_HE, CRL_HI, CR_UNDEAD)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots", 100, 0)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD)
...
------------------------------ UNIQUE --------------------------------------	
	...
	Monster.new("elder_gridor")
		:View("Elder Gridor", 'p', xWHITE, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 0, GFS_SUPRESS_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
		...
		:EquipCount(IM_SCROLL + IM_POTION, 3, 30)
		:Equip(IM_BODY, IT_CLOTHES, 100)
		:Equip(IM_WEAPON, IT_STAFF, 100)
		:Unique()
		:Register()

	Monster.new("jorgus")
		:View("Jorgus, the master thief", 'p', xWHITE, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
	...
	Monster.new("gekta")
		:View("Gekta, the sheep dog", 'C', xDARKGRAY, CPT_NAMED_IT, CRL_UNIQUE, CR_CANINE)
		:Basic("1d10+200", "0d0+1000", "1d100+300", CS_SMALL, "1d200+400")
		:Body("neck", 100, 0)
		:AI(AIF_HI_ANIMAL + AIF_PEACEFUL)
	...
	Monster.new("highpriest")
		:View("Aphilius, the high priest of Avanor", 'p', xWHITE, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMANOID)
	...
	Monster.new("ozorik")
		:View("Ozorick, the royal guard captain", 'p', xLIGHTBLUE, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 100, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
		:Stats("St 1d8+30 Dx 1d8+30 To 1d8+15 Le 1d5+15 Wi 1d4+5 Ma 1d4+5 Pe 3d6 Ch 5d5")
	...
	Monster.new("yohjishiro")
		:View("Yohjishiro, the elven wizard", 'h', xWHITE, CPT_NAMED_SHE, CRL_UNIQUE, CR_HUMANOID)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 100, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
		...
		:LearnSpell(SPELL_HEAL)
		:Equip(IM_HAT, IT_HAT, 100)
		:Equip(IM_WEAPON, IT_STAFF, 100)
		:Unique()
		:Register()

	Monster.new("gefeon")
		:View("Gefeon, great master of Fire", 'p', xRED, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
	...
	Monster.new("roderik")
		:View("Roderick, king of Avanor", 'p', xYELLOW, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
	...
	Monster.new("ahkulan")
		:View("Ahk-Ulan, great master of Darkness", 'p', xDARKGRAY, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
	...
	Monster.new("todin")
		:View("Todin, dwarven weaponsmith", 'h', xBROWN, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMANOID)
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 100, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
		:Stats("St 1d8+30 Dx 1d8+30 To 1d8+15 Le 1d5+15 Wi 1d4+5 Ma 1d4+5 Pe 3d6 Ch 5d5")
	...
	Monster.new("torin")
		:View("Torin the Great, dwarven king", 'h', xLIGHTGREEN, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMANOID)
		:Basic("1d10+100", "0d0+800", "0d0+800", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 100, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD + AIF_PEACEFUL)
	...
	Monster.new("beelzevile")
		:View("Beelzevile, the horned demon", '&', xLIGHTCYAN, CPT_NAMED_HE, CRL_UNIQUE, CR_DEMON)
		:Basic("1d30+50", "0d0+1500", "0d0+900", CS_LARGE, "1d400+4000")
		:Body("head body ring ring", 100, GFS_SUPRESS_INVIS + GFS_SEE_INVIS)
		:AI(AIF_RANDOM_MOVE + AIF_ALLOW_PICK_UP + AIF_ALLOW_WEAR_ITEM + AIF_COWARD)
	...
	Monster.new("xshee_voo")
		:View("Xshee-Voo, the Cyclope", 'H', xLIGHTMAGENTA, CPT_NAMED_HE, CRL_UNIQUE, CR_GIANT)
	...
	Monster.new("magnush")
		:View("Magnush, the Kobold Lord", 'k', xRED, CPT_NAMED_HE, CRL_UNIQUE, CR_KOBOLD)
		...
		:LearnSkill(SKT_HEALING, 10)
		:LearnSkill(SKT_FINDWEAKNESS, 10)
		:EquipCount(IM_SCROLL + IM_POTION + IM_BOOK + IM_FOOD, 6, 20)
		:Equip(IM_WEAPON, IT_DAGGER, 100)
		:CorpseEffect(CET_DISEASE, 30)
	...
	Monster.new("rotmoth", "bandit")
		:View("Rotmoth", 'p', xDARKGRAY, CPT_NAMED_HE, CRL_UNIQUE, CR_HUMAN)
		:Description("NO DESCRIPTION, PLEASE HELP TO CREATE THEM...")
		:Unique()
		:Register()

	Monster.new("giana", "goodwife")
		:View("Giana", 'p', xLIGHTRED, CPT_NAMED_SHE, CRL_UNIQUE, CR_HUMAN)
		:Description("NO DESCRIPTION, PLEASE HELP TO CREATE THEM...")
		:Unique()
		:Register()
end
