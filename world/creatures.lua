...
------------------------------ RATS --------------------------------------
	Monster.new("rat")
		...
		:Body("", 0, 0)
		:AI(AI_FLAG.AIF_COWARD + AI_FLAG.AIF_RANDOM_MOVE + AI_FLAG.AIF_ALLOW_PACK)
...
------------------------------ BATS --------------------------------------	
	Monster.new("bat")
		...
		:Body("", 0, 0)
		:AI(AI_FLAG.AIF_COWARD + AI_FLAG.AIF_RANDOM_MOVE)
...
------------------------------ CANINE --------------------------------------
	...
	Monster.new("dog")
		...
		:Body("", 0, 0)
		:AI(AI_FLAG.AIF_HI_ANIMAL + AI_FLAG.AIF_ALLOW_PACK + AI_FLAG.AIF_ALLOW_PACK)
	...
	Monster.new("rabid_dog")
		...
		:Body("", 0, 0)
		:AI(AI_FLAG.AIF_HI_ANIMAL + AI_FLAG.AIF_ALLOW_PACK)
...
------------------------------ KOBOLDS --------------------------------------
	...
	Monster.new("kobold")
		...
		:AI(AI_FLAG.AIF_CREATURE + AI_FLAG.AIF_ALLOW_PACK)
...
------------------------------ HUMANS & HUMANOIDS --------------------------------------	
	...
	Monster.new("farmer")
		...
		:AI(AI_FLAG.AIF_HUMAN + AI_FLAG.AIF_PEACEFUL)
	...
	Monster.new("death_knight")
		...
		:Basic("1d10+95", "0d0+1000", "0d0+1000", CS_NORMAL, "1d200+1200")
		:Body("head neck body cloak hand hand ring ring gloves boots light_source tool missile_weapon missile", 50, 0)
		:AI(AI_FLAG.AIF_RANDOM_MOVE + AI_FLAG.AIF_ALLOW_PICK_UP + AI_FLAG.AIF_ALLOW_WEAR_ITEM + AI_FLAG.AIF_COWARD)
	...
	Monster.new("shopkeeper")
		...
		:AI(AI_FLAG.AIF_RANDOM_MOVE + AI_FLAG.AIF_ALLOW_PICK_UP + AI_FLAG.AIF_ALLOW_WEAR_ITEM + AI_FLAG.AIF_COWARD + AI_FLAG.AIF_PEACEFUL)
...
------------------------------ UNDEAD --------------------------------------	
	...
	Monster.new("skeleton")
		...
		:AI(AI_FLAG.AIF_RANDOM_MOVE + AI_FLAG.AIF_ALLOW_PICK_UP + AI_FLAG.AIF_ALLOW_WEAR_ITEM)
...
------------------------------ UNIQUE --------------------------------------	
	...
	Monster.new("gekta")
		...
		:Body("neck", 100, 0)
		:AI(AI_FLAG.AIF_HI_ANIMAL + AI_FLAG.AIF_PEACEFUL)
