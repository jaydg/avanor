...
function MakeDwarvenCity()
	...
	CreateLocation("DWARFCITYCAVE2", "PDC:2", "Path to the Dwarven City Level 2", XLocation.DELVE, DwarfPathShape())
		...
		Settle({"undead", "blob", "insect", "reptile", "rat", "feline", "canine"}, CreatureTemplate.LOW)
	...
	CreateLocation("DWARFCITYCAVE6", "PDC:6", "Path to the Dwarven City Level 6", XLocation.DELVE, DwarfPathShape())
		...
		Settle({"undead", "blob", "insect", "reptile", "rat", "feline", "canine", "goblin", "kobold"}, CreatureTemplate.LOW)
	...
	CreateLocation("GASMINE1", "GM:1", "Gassed Mine level 1", XLocation.DUNGEON, Dungeon())
		Way(XStairWay.UP, "DWARFCITY")
		Way(XStairWay.DOWN, "GASMINE2")
--		Settle("blob", CreatureTemplate.VERY_LOW)
		EventPlace('GasMineEvent')

	CreateLocation("GASMINE2", "GM:2", "Gassed Mine level 2", XLocation.DUNGEON, Dungeon(40))
		Way(XStairWay.UP, "GASMINE1")
		Way(XStairWay.DOWN, "GASMINE3")
--		Settle("blob", CreatureTemplate.VERY_LOW)
		EventPlace('GasMineEvent')

	CreateLocation("GASMINE3", "GM:3", "Gassed Mine level 3", XLocation.DUNGEON, Dungeon(40))
