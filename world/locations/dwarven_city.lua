...
function MakeDwarvenCity()
	...
	CreateLocation("DWARFCITYCAVE2", "PDC:2", "Path to the Dwarven City Level 2", XLocation.DUNGEON)
	...
	CreateLocation("DWARFCITYCAVE3", "PDC:3", "Path to the Dwarven City Level 3", XLocation.DUNGEON)
		Way(XStairWay.UP, "DWARFCITYCAVE2")
		Way(XStairWay.DOWN, "DWARFCITYCAVE4")
		Settle(CreatureClass.UNDEAD + CreatureClass.BLOB + CreatureClass.INSECT + CreatureClass.REPTILE + CreatureClass.RAT + CreatureClass.FELINE + CreatureClass.CANINE, CreatureTemplate.LOW)

	CreateLocation("DWARFCITYCAVE4", "PDC:4", "Path to the Dwarven City Level 4", XLocation.DUNGEON)
		Way(XStairWay.UP, "DWARFCITYCAVE3")
		Way(XStairWay.DOWN, "DWARFCITYCAVE5")
		Settle(CreatureClass.UNDEAD + CreatureClass.BLOB + CreatureClass.INSECT + CreatureClass.REPTILE + CreatureClass.RAT + CreatureClass.FELINE + CreatureClass.CANINE, CreatureTemplate.LOW)

	CreateLocation("DWARFCITYCAVE5", "PDC:5", "Path to the Dwarven City Level 5", XLocation.DUNGEON)
		Way(XStairWay.UP, "DWARFCITYCAVE4")
		Way(XStairWay.DOWN, "DWARFCITYCAVE6")
		Settle(CreatureClass.UNDEAD + CreatureClass.BLOB + CreatureClass.INSECT + CreatureClass.REPTILE + CreatureClass.RAT + CreatureClass.FELINE + CreatureClass.CANINE, CreatureTemplate.LOW)

	CreateLocation("DWARFCITYCAVE6", "PDC:6", "Path to the Dwarven City Level 6", XLocation.DUNGEON)
...
--		Settle(CreatureClass.BLOB, CreatureTemplate.VERY_LOW)
	...
	CreateLocation("GASMINE2", "GM:2", "Gassed Mine level 2", XLocation.DUNGEON)
		Way(XStairWay.UP, "GASMINE1")
		Way(XStairWay.DOWN, "GASMINE3")
--		Settle(CreatureClass.BLOB, CreatureTemplate.VERY_LOW)
		EventPlace('GasMineEvent')

	CreateLocation("GASMINE3", "GM:3", "Gassed Mine level 3", XLocation.DUNGEON)
