...
function MakeDwarvenCity()
	CreateLocation("DWARFCITYCAVE1", "PDC:1", "Path to the Dwarven City Level 1", DUNGEON)
		Way(UP, "MAIN")
		Way(DOWN, "DWARFCITYCAVE2")
	...
	CreateLocation("DWARFCITYCAVE2", "PDC:2", "Path to the Dwarven City Level 2", DUNGEON)
		Way(UP, "DWARFCITYCAVE1")
		Way(DOWN, "DWARFCITYCAVE3")
	...
	CreateLocation("DWARFCITYCAVE3", "PDC:3", "Path to the Dwarven City Level 3", DUNGEON)
		Way(UP, "DWARFCITYCAVE2")
		Way(DOWN, "DWARFCITYCAVE4")
		Settle(CreatureClass.UNDEAD + CreatureClass.BLOB + CreatureClass.INSECT + CreatureClass.REPTILE + CreatureClass.RAT + CreatureClass.FELINE + CreatureClass.CANINE, CreatureTemplate.LOW)

	CreateLocation("DWARFCITYCAVE4", "PDC:4", "Path to the Dwarven City Level 4", DUNGEON)
		Way(UP, "DWARFCITYCAVE3")
		Way(DOWN, "DWARFCITYCAVE5")
		Settle(CreatureClass.UNDEAD + CreatureClass.BLOB + CreatureClass.INSECT + CreatureClass.REPTILE + CreatureClass.RAT + CreatureClass.FELINE + CreatureClass.CANINE, CreatureTemplate.LOW)

	CreateLocation("DWARFCITYCAVE5", "PDC:5", "Path to the Dwarven City Level 5", DUNGEON)
		Way(UP, "DWARFCITYCAVE4")
		Way(DOWN, "DWARFCITYCAVE6")
		Settle(CreatureClass.UNDEAD + CreatureClass.BLOB + CreatureClass.INSECT + CreatureClass.REPTILE + CreatureClass.RAT + CreatureClass.FELINE + CreatureClass.CANINE, CreatureTemplate.LOW)

	CreateLocation("DWARFCITYCAVE6", "PDC:6", "Path to the Dwarven City Level 6", DUNGEON)
		Way(UP, "DWARFCITYCAVE5")
		Way(DOWN, "DWARFCITY")
	...
	CreateLocation("DWARFCITY", "DvCty", "Dwarven City", CAVE)
		SetPattern(80, 20,
		"################################################################################" ..
		"###############,,,,,,,############,,,,,,,####G####################,,,,##F++E,,A#" ..
		"##,,,,,,,,,,,,,,,,,,,,,,,,,,,,,P,,,,,,,,,,,,,;,,,,,,,,,,,,,,,#####,,,,#####,,,A#" ..
		...
		AddTranslation("<", function(x, y) Way(UP, "DWARFCITYCAVE6", x, y) end)
		...
		AddTranslation("F", function(x, y) Way(DOWN, "DWARFTREASURE", x, y) end)
		AddTranslation("G", function(x, y) Way(DOWN, "GASMINE1", x, y) end)
		DrawPattern(0, 0)

	CreateLocation("DWARFTREASURE", "DvTr", "Dwarven Treasure", CAVE)
		SetPattern(80, 20,
		"################################################################################" ..
		"################################################################################" ..
		"################################################################################" ..
		...
		AddTranslation("<", function(x, y) Way(UP, "DWARFCITY", x, y) end)
	...
	CreateLocation("GASMINE1", "GM:1", "Gassed Mine level 1", DUNGEON)
		Way(UP, "DWARFCITY")
		Way(DOWN, "GASMINE2")
--		Settle(CreatureClass.BLOB, CreatureTemplate.VERY_LOW)
		EventPlace('GasMineEvent')

	CreateLocation("GASMINE2", "GM:2", "Gassed Mine level 2", DUNGEON)
		Way(UP, "GASMINE1")
		Way(DOWN, "GASMINE3")
--		Settle(CreatureClass.BLOB, CreatureTemplate.VERY_LOW)
		EventPlace('GasMineEvent')

	CreateLocation("GASMINE3", "GM:3", "Gassed Mine level 3", DUNGEON)
		Way(UP, "GASMINE2")
--		Settle(CreatureClass.BLOB, CreatureTemplate.VERY_LOW)
		EventPlace('GasMineEvent')
