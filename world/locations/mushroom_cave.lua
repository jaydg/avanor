...
function MakeMushroomCave()
	CreateLocation("MUSHROOMS_CAVE1", "MC:1", "Mushroom Caves Level 1", CAVE)
		Way(UP, "MAIN")
		Way(DOWN, "MUSHROOMS_CAVE2")
	...
	CreateLocation("MUSHROOMS_CAVE2", "MC:2", "Mushroom Caves Level 2", CAVE)
		Way(UP, "MUSHROOMS_CAVE1")
		Way(DOWN, "MUSHROOMS_CAVE3")
		Way(DOWN, "MUSHROOMS_CAVE5")
		CreateBeelzevile()
		Settle(CreatureClass.INSECT + CreatureClass.REPTILE, CreatureTemplate.VERY_LOW)

	CreateLocation("MUSHROOMS_CAVE3", "KC:1", "Kobold Cavern Level 1", CAVE)
		Way(UP, "MUSHROOMS_CAVE2")
		Way(DOWN, "MUSHROOMS_CAVE4")
		Settle(CreatureClass.KOBOLD + CreatureClass.INSECT + CreatureClass.REPTILE, CreatureTemplate.VERY_LOW)

	CreateLocation("MUSHROOMS_CAVE4", "KC:2", "Kobold Cavern Level 2", CAVE)
		Way(UP, "MUSHROOMS_CAVE3")
		Settle(CreatureClass.KOBOLD, CreatureTemplate.LOW + CreatureTemplate.VERY_LOW)
		Creature("magnush")

	CreateLocation("MUSHROOMS_CAVE5", "MC:3", "Mushroom Caves Level 3", CAVE)
		Way(UP, "MUSHROOMS_CAVE2")
