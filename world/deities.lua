...
Deity.new("life")
	...
	:Grants("cure light wounds", "adept", 3, XEffect.CURE_LIGHT_WOUNDS)
	:Grants("minor divine intervention", "adept", 5, XEffect.MAGIC_ARROW)
	:Grants("cure poison", "follower", 10, XEffect.CURE_POISON)
	:Grants("heroism", "follower", 10, XEffect.HEROISM)
	:Grants("cure critical wounds", "messiah", 20, XEffect.CURE_CRITICAL_WOUNDS)
	:Grants("great knowledge", "messiah", 30, XEffect.IDENTIFY)
	:Grants("divine restoration", "champion", 50, XEffect.RESTORATION)
	:Register()

Deity.new("death")
	:Called("Marduk")
	:OnKill("MardukWatches")
	:Grants("cure light wounds", "adept", 5, XEffect.CURE_LIGHT_WOUNDS)
	:Grants("minor divine intervention", "adept", 5, XEffect.MAGIC_ARROW)
	:Grants("divine intervention", "follower", 5, XEffect.FIRE_BOLT, XEffect.ICE_BOLT)
	:Grants("divine escape", "follower", 50, XEffect.TELEPORT)
	:Grants("cure critical wounds", "messiah", 30, XEffect.CURE_CRITICAL_WOUNDS)
	:Grants("knowledge of insight", "messiah", 50, XEffect.SELF_KNOWLEDGE)
	:Grants("major divine intervention", "champion", 5, XEffect.LIGHTNING_BOLT, XEffect.ACID_BOLT)
	:Register()
