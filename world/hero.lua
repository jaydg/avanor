...
HERO_KITS["alchemist"] = function(hero, who, race)
	...
	Identify(potion)
	who:ContainItem(AsItem(potion))
	potion = CreatePotion("orange_juice")
	Identify(potion)
	who:ContainItem(AsItem(potion))
	potion = CreatePotion("apple_juice")
	Identify(potion)
	who:ContainItem(AsItem(potion))
	potion = CreatePotion("water")
	Identify(potion)
	who:ContainItem(AsItem(potion))
	tool = CreateObject("alchemy_set")
