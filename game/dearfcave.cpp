...
//	location_name = l_name;
	...
	switch (l_name)
	{
		case L_DWARFCITYCAVE1:
			...
			Game.Sheduler.Add(new XUniversalGen(this, (CREATURE_CLASS)(CR_UNDEAD | CR_INSECT | CR_REPTILE | CR_RAT | CR_FELINE | CR_CANINE), CRL_VERY_LOW, 10, 10000));
			break;
		...
		case L_DWARFCITYCAVE2:
			...
			Game.Sheduler.Add(new XUniversalGen(this, (CREATURE_CLASS)(CR_UNDEAD | CR_INSECT | CR_REPTILE | CR_RAT | CR_FELINE | CR_CANINE), CRL_LOW, 10, 10000));
			break;
		...
		case L_DWARFCITYCAVE6:
			...
			Game.Sheduler.Add(new XUniversalGen(this, (CREATURE_CLASS)(CR_UNDEAD | CR_INSECT | CR_REPTILE | CR_RAT | CR_FELINE | CR_CANINE | CR_GOBLIN | CR_KOBOLD), CRL_LOW, 10, 10000));
