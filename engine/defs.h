...
enum STARWAYTYPE {STW_UNKNOWN = 0, STW_UP, STW_DOWN };
...
enum STDMAP {M_UNKNOWN = 0, M_GREENGRAS, M_GREENTREE, M_SEND, M_WOODWALL,
M_MAGMA, M_QUARTZ, M_CAVEFLOOR, M_STONEFLOOR, M_PATH, M_STONEWALL, M_WATER, M_DEEPWATER,
M_HILL, M_LOWMOUNTINE, M_MOUNTINE, M_HIGHMOUNTINE, M_BRIDGE, M_ROAD, M_OBSIDIANFLOOR,
